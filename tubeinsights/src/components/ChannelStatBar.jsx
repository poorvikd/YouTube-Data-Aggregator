// Desc: This file contains the ChannelStatBar component which is used to display the channel statistics. It takes the channel data as props and renders the channel statistics in a card format.
